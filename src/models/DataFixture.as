...
//		}
		...
		private static function getFixedAuditItems():ArrayList
		{
			return new ArrayList(
				[
					new AuditItem("","0303-Camden Motors","Inspect all documents.","Physical 77-83 Grovebuy road leighton buzzard beds,lu7 8te","Schedule for:10/01/2013","62","Vehicles","0","0","0","62"),
					new AuditItem("","8900-Iuton Cars Ltd","Check vehicles also in the underground.","Physical 97 Grange Road Luton Hal Street,Beds LU1 988","Schedule for:10/03/2013","12","Vehicles","0","0","0","12"),
					new AuditItem("","7356-Spark Cars Ltd","Check vehicles also in the underground.","Physical 77-83 Grovebuy road leighton buzzard beds,lu7 8te","Schedule for:10/07/2013","3","Vehicles","0","0","0","3")
				]
			);	
		}
		private static function getFixedVehicleItems():ArrayList
		{
			return new ArrayList(
				[
